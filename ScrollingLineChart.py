...
from PySide6.QtCore import Qt, QTimer, QPointF, pyqtSignal, Signal
...
class ScrollingLineChart(QWidget):
    ...
    dataPointAdded = Signal(str, float, float)  # series_name, x_value, y_value
    ...
    def add_data_point(self, series_name: str, x_value: float, y_value: float):
        """
        Add a new data point to the specified series
        
        Args:
            series_name: Name of the series to add data to
            x_value: X coordinate (typically time or index)
        ...
        self.data_series[series_name].append((x_value, y_value))
        ...
        # Emit signal
        self.dataPointAdded.emit(series_name, x_value, y_value)
    ...
    def auto_adjust_axes(self):
        ...
        self.y_axis.setRange(y_min - y_padding, y_max + y_padding)
