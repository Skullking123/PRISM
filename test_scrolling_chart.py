...
class ScrollingChartTest(QWidget):
    ...
    def generate_test_data(self):
        ...
        # Add data points
        self.chart.add_data_point("Sine Wave", sine_value)
        self.chart.add_data_point("Cosine Wave", cosine_value)
        self.chart.add_data_point("Random Walk", self.random_value)
